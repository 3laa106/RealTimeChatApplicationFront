...
export const fetchChats = createAsyncThunk(
  ...
  async (searchQuery = "") => {
    const response = await fetch(
      `https://chatiov2-grh8d4hghbb5edbc.uaenorth-01.azurewebsites.net/api/chat?searchTerm=${searchQuery}`,
      {
        method: "GET"
      }
    );
...
export const fetchGroupChats = createAsyncThunk(
  ...
  async (searchQuery = "") => {
    const response = await fetch(
      `https://chatiov2-grh8d4hghbb5edbc.uaenorth-01.azurewebsites.net/api/chat/group?searchTerm=${searchQuery}`,
      {
        method: "GET"
      }
    );
