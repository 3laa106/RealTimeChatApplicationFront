  ...
  async (userInfo, { rejectWithValue }) => {
    try {
      const response = await fetch(
        "https://chatiov2-grh8d4hghbb5edbc.uaenorth-01.azurewebsites.net/api/user",
        {
          method: "PUT",
          headers: {
...
export const changePassword = createAsyncThunk(
  ...
  async ({ oldPassword, newPassword }, { rejectWithValue }) => {
    try {
      const response = await fetch(
        "https://chatiov2-grh8d4hghbb5edbc.uaenorth-01.azurewebsites.net/api/user/change-password",
        {
          method: "PUT",
          headers: {
            "Content-Type": "application/json"
