...
const AddUserToGroupChat = () => {
  ...
  const handleOnSearchSubmit = async (e) => {
    ...
    try {
      ...
      const response = await fetch(
        `https://chatiov2-grh8d4hghbb5edbc.uaenorth-01.azurewebsites.net/api/user/?search=${search}`,
        {
          method: "GET"
        }
      );
  ...
  const handleCreateGroup = async (e) => {
    ...
    try {
      const response = await fetch(
        "https://chatiov2-grh8d4hghbb5edbc.uaenorth-01.azurewebsites.net/api/chat/group",
        {
          method: "POST",
          headers: {
